<footer class="mt-12 py-4 border-t border-gray-700 text-center text-gray-400">
    <div class="max-w-6xl mx-auto px-4">
        <p class="text-sm" id="copyright"><?php echo t('copyright'); ?></p>
...
<?php endif; ?>
<script>
    console.log('Sistema de tradução carregado:', typeof window.languageSystem);
    console.log('Navegação carregada:', typeof window.navigationSystem);
</script>