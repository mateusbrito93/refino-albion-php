</div> <footer class="mt-12 py-4 border-t border-gray-700 text-center text-gray-400">
        <div class="max-w-6xl mx-auto px-4">
            <p class="text-sm" id="copyright"></p> <p class="text-xs mt-1">
                By <span class="text-blue-300"><a href="https://www.linkedin.com/in/mateus-brito-071b1366/" target="_blank">Mateus Brito</a></span>
            </p>
        </div>
    </footer>

    <script src="js/script-index.js"></script> <?php if (basename($_SERVER['PHP_SELF']) == 'index.php'): ?>
