window.languageSystem = {
  ...
  getTranslations: function (section) {
    ...
    if (section === 'form') {
      return {
        ...
        cidadeCompra: t.form_cidadeCompraMadeira || "Cidade de Compra (Madeira)",
        cidadeVenda: t.form_cidadeVendaTabua || "Cidade de Venda (Tábua)",
  ...
  updateStaticTexts: function () {
    ...
    const elementsToTranslate = {
      ...
      titulominerio: document.getElementById("titulominerio"),
      titulomadeira: document.getElementById("titulomadeira"),
      titulopedra: document.getElementById("titulopedra"),
