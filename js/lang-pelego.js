...
function getFormTranslations(lang) {
  return {
    ...
    cidadeCompraPelego: window.translations[lang]?.form_cidadeCompraPelego || 'Cidade de Compra (Pelego)',
    cidadeVendaCouro: window.translations[lang]?.form_cidadeVendaCouro || 'Cidade de Venda (Couro)',
