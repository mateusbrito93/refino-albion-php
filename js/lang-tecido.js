...
const formTranslations = {
  pt: {
    ...
    cidadeCompra: "Cidade de Compra (Fibra)",
    cidadeVenda: "Cidade de Venda (Tecido)",
  ...
  en: {
    ...
    cidadeCompra: "Purchase City (Fiber)",
    cidadeVenda: "Sell City (Cloth)",
    quantidade: "Amount",
    taxaImposto: "Tax (Fee)",
  ...
  es: {
    ...
    cidadeCompra: "Ciudad de Compra (Fibra)",
    cidadeVenda: "Ciudad de Venta (Tejido)",
    quantidade: "Cantidad",
