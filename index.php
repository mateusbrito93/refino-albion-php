...
<main class="max-w-6xl mx-auto">
  echo "2"; flush();
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="card-refino bg-gray-800 rounded-xl p-6 shadow-lg transition-all duration-300 cursor-pointer"
             onclick="redirecionar('pelego')"> <div class="flex flex-col items-center text-center">
        ...
        <div class="card-refino bg-gray-800 rounded-xl p-6 shadow-lg transition-all duration-300 cursor-pointer"
             onclick="redirecionar('tecido')"> <div class="flex flex-col items-center text-center">
